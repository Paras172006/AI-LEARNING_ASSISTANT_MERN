...
const DocumentDetailPage = () => {
  ...
  const getPdfUrl = () => {
    ...
    const baseUrl = (typeof window !== 'undefined' && window.process?.env?.REACT_APP_API_URL)
...
// Change your tabs array to NOT call the functions directly
  const tabs = [
  ...
  // Helper to figure out which component to show based on the activeTab state
